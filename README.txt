...
There are botDev_installer JS files. All of these install botDev.js, but you can choose how to download it via which installer you download. The ones with .min.js are minimized versions of the installers, and these should install the code quicker due to less code. The ones with _min in the name install the minimized version of botDev.js.
